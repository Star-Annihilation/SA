local options={
  ...
  {
    key  = "sa_exp",
    name = "Star Annihilation - Experimental Options",
    desc = "Star Annihilation - Experimental Options",
    type = "section",
  },
  {
    key  = "sa_modes",
    name = "Star Annihilation - Game Modes",
    desc = "Star Annihilation - Game Modes",
    type = "section",
  },
  {
    key  = "sa_options",
    name = "Star Annihilation - Options",
    desc = "Star Annihilation - Options",
    type = "section",
  },
  {
    key  = "sa_wall_options",
    name = "Star Annihilation - Wall Options",
    desc = "Star Annihilation - Wall Options",
    type = "section",
  },
